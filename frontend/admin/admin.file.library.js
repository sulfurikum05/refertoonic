...
function populateWishTable(data) {
    ...
    data.forEach(item => {
        ...
        row.innerHTML = `
            ...
            <td>${item.title}</td>
            <td>${item.keywords}</td>
            <td><button class="delete-wishlist-video action-button" onClick="deleteWishlistVideo(this)" title="Delete"><img src="../icons/delete.png" class="icon" alt="delete_icon"></button></td>
