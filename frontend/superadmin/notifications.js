        ...
        row.innerHTML = `
            ...
            <td>
                <div class="actions_col">
                    <button class="delete-notification action-button" onClick="deleteNotification(this)" title="Delete"><img src="../icons/delete.png" class="icon" alt="delete_icon"></button>
                </div>
            </td>
        `;
