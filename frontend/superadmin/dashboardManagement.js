        ...
        row.innerHTML = `
                ...
                <td>
                    <div class="actions_col">
                        <button class="delete-video action-button" onClick="deleteSliderVideo(this)" title="Delete"><img src="../icons/delete.png" class="icon" alt="delete_icon"></button>
                    </div>
                </td>
            `;
...
function populateDashboardTextsTable(data) {
    ...
    data.forEach(item => {
        ...
        row.innerHTML = `
                ...
                <td>
                    <div class="actions_col">
                        <button class="edit-text action-button" onClick="editTextFunction(this)" title="Edit"><img src="../icons/edit.png" class="icon" alt="edit_icon"></button>
                        <button class="save-text action-button hide" title="Save"><img src="../icons/save.png" class="icon" alt="save_icon"></button>
...
function populateTeamTable(data) {
    ...
    data.forEach(item => {
        ...
        row.innerHTML = `
                ...
                <td>
                    <div class="actions_col">
                        <button class="edit-team action-button" onClick="editTeamfunction(this)" title="Edit"><img src="../icons/edit.png" class="icon" alt="edit_icon"></button>
                        <button class="save-team action-button hide" title="Save"><img src="../icons/save.png" class="icon" alt="save_icon"></button>
                    </div>
                </td>
            `;
...
function populatePaymentPackagesTable(data) {
    ...
    data.forEach(item => {
        ...
        row.innerHTML = `
                ...
                <td>
                    <div class="actions_col">
                        <button class="edit-payment-package action-button" onClick="editPpFunction(this)" title="Edit"><img src="../icons/edit.png" class="icon" alt="edit_icon"></button>
                        <button class="delete-payment-package action-button" onClick="deletePpFunction(this)" title="Delete"><img src="../icons/delete.png" class="icon" alt="delete_icon"></button>
                        <button class="save-payment-package action-button hide" title="Save"><img src="../icons/save.png" class="icon" alt="save_icon"></button>
...
document.querySelector('.videos-create-button').addEventListener('click', function () {
    ...
    newRow.innerHTML = `
            ...
            <td>
                ...
                <div class="actions_col">
                    <button class="upload-video action-button" title="Upload"><img src="../icons/upload.png" class="icon" alt="upload_icon"></button>
