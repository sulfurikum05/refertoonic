...
async function seed(pg) {
  ...
  try {
    ...
    await pg('dashboard_texts').insert([
      ...
      {
        header : "Activate the DEMO mode and get access to all platform functions for 24 hours",
    ...
    {
      user_id: "1",
      picture: "C:/Users/User/Desktop/JS/Gevor site 27.03 v2.0/Gevor site 07.03 v2.0/27.03/frontend/icons/avatar.jpg",
      name: "Gevorg",
      surname: "Hakobyan",
